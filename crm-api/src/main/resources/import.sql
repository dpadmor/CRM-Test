...
insert into customer (id, name, surname, created_by, created_at, updated_by, updated_at) values ('1', 'Daniel', 'Padrón Morales', 'ADMIN', sysdate, 'ADMIN', sysdate);
insert into customer (id, name, surname, created_by, created_at, updated_by, updated_at) values ('2', 'Juan', 'Padrón Morales', 'ADMIN', sysdate, 'ADMIN', sysdate);
